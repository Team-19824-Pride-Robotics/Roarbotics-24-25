...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1602.23452602791; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1355.8927788051917; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -550.0866217571563; // x position of the perpendicular encoder (in tick units)
    }
